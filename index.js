let currentIndex = 0;
  ...
  function updateProductDetails(index) {
    ...
    background.style.backgroundImage = product.color
    productDetailsContainer.innerHTML = `
      <h3 class="brand">${product.brand}</h3>
      <p class="Name">${product.Name}, <span class="choose">Choose Us</span></p>
  ...
  const data = [
    {
      ...
      "price" : "$499.00",
      "color" : "linear-gradient(to right,#F4A764,#FFDEC2)"
    },
    {
      ...
      "price" : "$469.00",
      "color" : "linear-gradient(to right,#ADB0B0,#E1E1E1)"
    },
    {
      ...
      "description" : "Discover the Perfect Watch for Every Occasion and Elevate Your Style with Timeless Elegance and Precision Craftsmanship - watch",
      "price" : "$529.00",
      "color" : "linear-gradient(to right,#30A357,#75E39A)"
    ...
    },
    {
      ...
      "description" : "Explore the Ideal Timepiece for Any Moment and Enhance Your Style with Timeless Sophistication and Impeccable Craftsmanship - timepiece",
      "price" : "$599.00",
      "color" : "linear-gradient(to right,#F24F4F,#FFA895)"
    }
  ];
